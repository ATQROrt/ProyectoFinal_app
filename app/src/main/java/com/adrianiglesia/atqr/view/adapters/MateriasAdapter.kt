...
class MateriasAdapter(private val materias:List<Materia>, private val itemClickListener: OnItemClickListener): RecyclerView.Adapter<MateriasAdapter.ViewHolder>() {
